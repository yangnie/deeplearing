...
filehandler = logging.handlers.RotatingFileHandler(
              LOG_FILENAME, maxBytes=20000, backupCount=8)
...
def main(_):
 ...
 #               my_logger.debug('step %d, training accuracy %g , duration = %s' % (i, train_accuracy, format(duration)))
                my_logger.debug('step %d, training accuracy %g' % (i, train_accuracy))
    ...
    my_logger.debug('test accuracy %g' % accuracy.eval(feed_dict={
